...
小丫姐，想实现下这个算法，利用CRISPR数据库，筛选出某种肿瘤细胞影响生长的基因，再结合TCGA数据库，对湿实验的指导意义非常大。谢谢啦
...
Figure 1C相关性展示可参考我们之前实现过的美图<https://mp.weixin.qq.com/s/D9wheY5QdnOh4JrjIc8-Cg>，

Figure 1D候选基因功能富集分析结果的展示可参考
...
Figure 1C correlation display can refer to our previous crowdfunded <https://mp.weixin.qq.com/s/D9wheY5QdnOh4JrjIc8-Cg>, 

Figure 1D can be found in Figure 1D for a presentation of the results of the candidate gene function enrichment assay, as shown in 
