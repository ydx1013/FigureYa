...
芯片数据从下载到差异分析可参考[FigureYa59Plus_GEO2DEG](https://www.yuque.com/figureYing/figureYingplus/figureYing59p)
...
For microarray data processing from download to differential analysis, see[FigureYa59Plus_GEO2DEG](https://www.yuque.com/figureYing/figureYingplus/figureYing59p)
