...
> 有关用clusterProfiler做GSEA的问题，建议加入Guangchuang Yu知识星球biobabble提问。

The following code is just to get the GSEA results in clusterProfiler format.

> For questions about GSEA with clusterProfiler, it is recommended to join Guangchuang Yu's Knowledge Planet biobabble to ask questions.
