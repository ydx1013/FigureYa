...
运行classpredict包，建议使用**Windows系统**。其他系统上可以用替代方案。

To run the classpredict package, **Windows OS** is recommended. Other systems are available with Plan B.
...
resList <- classPredict(exprTrain = train.data, exprTest = test.data, isPaired = FALSE,
                        ...
                        outputName = "ClassPrediction", generateHTML = F)
