...
```{r}
names(gse@gsms)[1:5] # sample names
gsmplatforms <- lapply(gse@gsms, function(x) {x@header$platform_id})
...
gsmlist = Filter(function(gsm) {gsm@header$platform_id=='GPL22286'}, gse@gsms)
Table(gsmlist[[1]])[1:5,]
