...
需要表达数据和临床信息作为输入：
Expression data and clinical information are required as input:
...
- GSE85217_family.soft.gz, expression data. Download required data and read data. We directly download files from <https://ftp.ncbi.nlm.nih.gov/geo/series/GSE85nnn/GSE85217/soft/GSE85217_family.soft.gz>
- easyinput_clinicaldata.csv, clinical information.

GSE文件已上传到微云，下载链接：<https://share.weiyun.com/5X52f08>
The GSE file has been uploaded to Weiyun. Download link: <https://share.weiyun.com/5X52f08>
