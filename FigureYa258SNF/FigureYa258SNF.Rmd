...
expr <- fread(unz("easy_input_expr.txt.zip", "easy_input_expr.txt"), sep = "\t", check.names = F, stringsAsFactors = F, header = T, data.table = F)
...
beta <- fread(unz("easy_input_beta.txt.zip", "easy_input_beta.txt"), sep = "\t", check.names = F, stringsAsFactors = F, header = T, data.table = F)
