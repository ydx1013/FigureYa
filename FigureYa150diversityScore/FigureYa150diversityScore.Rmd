...
使用国内镜像安装包
Use domestic mirror installation package
...
> Worried that you may not be able to download smoothly, Xiaoya uploaded these four files to Weiyun, download link: <https://share.weiyun.com/54uouqH>, after downloading and unzipping, there is a folder `data`, which is placed in the same directory as the `FigureYa150diversityScore.Rmd` file.
