...
# Keep the same order as the training set (just for the sake of looking good)
...
head(mulcox.geo) # 该死，这个riskscore在测试集里不是独立预后因素，但nobody cares，继续画图  # Damn it, this riskscore is not an independent prognostic factor in the test set, but nobody cares, keep plotting
```
