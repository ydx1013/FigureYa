...
<div style="font-family: sans-serif; max-width: 800px; margin: 2em auto; padding: 1em; border: 1px solid #ddd; border-radius: 8px; background-color: #f9f9f9;">
    ...
    <p>Welcome! This page provides a searchable interface for all reports and figures generated by the <strong>FigureYa</strong> project. It's designed to help you quickly find and explore the results[...]
    <hr>
    <h2>How to Use This Page</h2>
    <ul>
        <li><strong>Search Everything:</strong> Use the <strong>search box below</strong> to perform a full-text search across all reports. You can look for a gene name, an R package, a specific analy[...]
    ...
    <p>All input files, analysis code (Rmd), and results are publicly available in the <a href="https://github.com/ying-ge/FigureYa/" target="_blank">main GitHub repository</a>. You can browse the fil[...]
<h2>Citation</h2>
<p>Xiaofan Lu, et al. (2025). FigureYa: A Standardized Visualization Framework for Enhancing Biomedical Data Interpretation and Research Efficiency. <i>iMetaMed</i>. <a href="https://doi.org/10.1002/i[...]
</div>
<hr>
