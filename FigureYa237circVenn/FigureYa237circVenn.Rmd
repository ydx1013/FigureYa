...
展示多组之间的overlap genes、以及每组specific genes，通常会用到venn图（可参考 [FigureYa112venn](https://www.yuque.com/figureYing/figureYingplus/figureYing112p)），有太多组需要对比的话还可以像例文这样画成环形图。

# Application Scenarios

To show the overlap genes between multiple groups and each specific gene, a venn diagram is usually used (see [FigureYa112venn](https://www.yuque.com/figureYing/figureYingplus/figureYing112p)), and if there are too many groups to compare, you can draw a donut chart like the example text.
...
- 用[FigureYa59Plus_GEO2DEG](https://www.yuque.com/figureYing/figureYingplus/figureYing59p)获得芯片的差异表达分析结果文件`easy_input_limma.csv`
...
- Obtain the differential expression analysis result file 'easy_input_limma.csv' of the chip with [FigureYa59Plus_GEO2DEG](https://www.yuque.com/figureYing/figureYingplus/figureYing59p)
