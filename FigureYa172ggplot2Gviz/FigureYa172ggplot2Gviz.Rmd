...
使用国内镜像安装包
Use a domestic mirror to install the package
...
- The above data has been uploaded to Weiyun for easy download <https://share.weiyun.com/55dfZPV>
...
Mouse and human gene annotation files are typically generated using Gencode. The mm9 gtf file is available at: <https://www.gencodegenes.org/mouse/release_M9.html>, and has been uploaded to Weiyun for easy download: <https://share.weiyun.com/55dfZPV>. Human annotations are available at <https://www.gencodegenes.org/human/>. Other species can be downloaded from Ensembl: <http://asia.ensembl.org/info/data/ftp/index.html>.
