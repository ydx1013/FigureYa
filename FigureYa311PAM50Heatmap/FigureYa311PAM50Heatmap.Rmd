...
data_mrna_seq_fpkm_polYing.txt，表达矩阵。可以从百度网盘下载<https://pan.baidu.com/s/1vwBmgnDV5-ee6q5DP_-7Fg?pwd=m2mg>
...
data_mrna_seq_fpkm_polYing.txt - Expression matrix. Available for download on BaiduNetdisk<https://pan.baidu.com/s/1vwBmgnDV5-ee6q5DP_-7Fg?pwd=m2mg>
...
eset <- read.table("data_mrna_seq_fpkm_polYing.txt", header = T, sep = "\t", check.names = F)
