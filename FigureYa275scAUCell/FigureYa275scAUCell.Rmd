...
最后选取High.ISGs组的基因去做GO和pathway，可以用Y叔的clusterProfiler包或者各种在线包，更多富集分析展示方式看这里

最核心还是找到适合自己研究思路的基因集！

Finally, select genes from the High.ISGs group for GO and pathway analysis. You can use Dr. Y's clusterProfiler package or various online tools. For more enrichment visualization methods, see: 
