...
**Note: * * This crowdfunding does not involve batch effect elimination. If there are batch effects between samples, please read the edgeR document and include batch effects in the design matrix< https://bioconductor.org/packages/release/bioc/vignettes/edgeR/inst/doc/edgeRUsersGuide.pdf >Here is a complete example: 4.2 RNA Seq of pathogenic uncoordinated arabidopsis with batch effects
