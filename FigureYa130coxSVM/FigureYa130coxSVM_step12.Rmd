...
使用国内镜像安装包
Use domestic mirrors to install packages
...
#提取肿瘤的差异化甲基化位点矩阵
# Extract DMP matrix for tumor samples only
...
To obtain HR and confidence intervals, run batch survival analysis. This may take time – be patient
...
Further filter the tumor methylation matrix – to be used for SVM-based feature selection
...
Next, proceed to Steps 3 and 4. Open the FigureYa130coxSVM_step34.ipynb notebook and use the CSV file TCGA-LIHC-survival-relevant-DMP-matrix.csv generated in Step 2 as input.
