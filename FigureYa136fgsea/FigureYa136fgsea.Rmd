...
Use Uncle Y's **clusterProfiler** to do GSEA analysis, and then use base plot to draw a graph similar to the original paper. For similar usage, please refer to FigureYa60GSEA_clusterprofiler.
...
Use the results of the GSEA JAVA version (GSEA folder, Weiyun link <https://share.weiyun.com/5FYDPQZ>) as input, organize the data format, and then draw the graph. The drawing code is similar to that of method 2.
